...
public class RCVKThu extends RecyclerView.Adapter<RCVKThu.ViewHolder> {
    ...
    public RCVKThu(Context context, ArrayList<GiaoDich> list) {
...
//                        Toast.makeText(getActivity(), "Xóa",Toast.LENGTH_SHORT).show();
        ...
        holder.imgXoa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Bạn có chắc chắn muốn xóa khoản thu?")
                        .setCancelable(false)
